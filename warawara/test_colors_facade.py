...
from warawara import Emphasis, bold, lowint, underline, blink, reverse, invisible
from warawara import Color, Color8, Color256, ColorRGB, ColorHSV
...
class TestColorFacade(TestCase):
    ...
    def test_color__parse_tokenize(self):
        ...
        # function under test
        fut = lambda x: list(warawara.colors._tokenize(x))
    ...
    def test_color_parse(self):
        ...
        # em + fg (256) + bg (RGB)
        self.eq(color('\033[1;4;5;38;5;214;48;2;192;255;238m'), paint(em=Emphasis(bold=True, underline=True, blink=True),
                                                              fg=Color256(214),
        ...
        # Valid seq and reset
        self.eq(color('\033[31;35;37;0m'), color())

        # Valid seq and reset and more seq
        self.eq(color('\033[31;35;37;0;32m'), Color8(2))
